...
from llmperf.ray_clients.azureaistudio_client import AzureAIStudioChatCompletionsClient
...
def construct_clients(llm_api: str, num_clients: int) -> List[LLMClient]:
    ...
    elif llm_api == "azureaistudio":
        clients = [AzureAIStudioChatCompletionsClient.remote() for _ in range(num_clients)]
